...
const docTemplate = `{
    ...
    "paths": {
        "/projects/{project_id}/graph": {
            "get": {
                ...
                "description": "Возвращает список задач с именами авторов\nМеняет статус (todo → in_progress → done). Только исполнитель или admin+\nВозвращает все задачи и связи",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/smartsync_internal_models.Task"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "smartsync_internal_models.Task": {
            "type": "object",
            "properties": {
                "assignee_id": {
                    "description": "Указатель, т.к. может быть NULL",
                    "type": "integer"
                },
                "assignee_name": {
                    "description": "Имя для фронтенда",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
